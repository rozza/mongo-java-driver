...
class MapReduceFluentSpecification
    ...
    def 'should build the expected MapReduceWithInlineResultsOperation'() {
        ...
        def fluentMapReduce = new MapReduceFluentImpl(namespace, Document, codecRegistry, readPreference, executor,
                'map', 'reduce')

        when: 'default input should be as expected'
        fluentMapReduce.into([]) { result, t -> }
        ...
        fluentMapReduce.filter(new Document('filter', 1))
    ...
    def 'should build the expected MapReduceToCollectionOperation'() {
        ...
        fluentMapReduce.toCollection(futureResultCallback)
    ...
    def 'should handle exceptions correctly'() {
        ...
        def fluentMapReduce = new MapReduceFluentImpl(namespace, BsonDocument, codecRegistry, readPreference, executor,
                'map', 'reduce')

        def futureResultCallback = new FutureResultCallback<List<BsonDocument>>()

        when: 'The operation fails with an exception'
        fluentMapReduce.into([], futureResultCallback)
        futureResultCallback.get()
        ...
        fluentMapReduce.toCollection(new FutureResultCallback())
        ...
        new MapReduceFluentImpl(namespace, Document, codecRegistry, readPreference, executor,
    ...
    def 'should follow the MongoIterable interface as expected'() {
        ...
        def mongoIterable = new AggregateFluentImpl<Document>(namespace, Document, codecRegistry, readPreference, executor,
