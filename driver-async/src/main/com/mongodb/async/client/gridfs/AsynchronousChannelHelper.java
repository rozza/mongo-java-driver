...
public final class AsynchronousChannelHelper {
     ...
     */
    public static AsyncInputStream toAsyncInputStream(final AsynchronousByteChannel asynchronousByteChannel) {
     ...
     * @return the AsyncInputStream
     */
    public static AsyncInputStream toAsyncInputStream(final AsynchronousFileChannel asynchronousFileChannel) {
     ...
     */
    public static AsyncOutputStream toAsyncOutputStream(final AsynchronousByteChannel asynchronousByteChannel) {
        notNull("asynchronousByteChannel", asynchronousByteChannel);
     ...
     * @return the AsyncOutputStream
     */
    public static AsyncOutputStream toAsyncOutputStream(final AsynchronousFileChannel asynchronousFileChannel) {
        notNull("asynchronousByteChannel", asynchronousFileChannel);
        return new AsyncOutputStream() {
            private int position = 0;
            @Override
