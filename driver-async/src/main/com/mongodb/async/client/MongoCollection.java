...
public interface MongoCollection<T> {
     ...
     * @mongodb.driver.manual reference/command/distinct/ Distinct
     */
    MongoFuture<List<Object>> distinct(String fieldName, Object filter, DistinctOptions distinctOptions);
     ...
     *
     * @param documents the documents to insert
     * @param insertManyOptions the options to apply to the operation
     * @throws com.mongodb.DuplicateKeyException
     * @throws com.mongodb.MongoException
     */
    MongoFuture<WriteConcernResult> insertMany(List<? extends T> documents, InsertManyOptions insertManyOptions);
     ...
     */
    MongoFuture<UpdateResult> replaceOne(Object filter, T replacement, UpdateOptions updateOptions);
     ...
     * @mongodb.driver.manual reference/operator/update/ Update Operators
     */
    MongoFuture<UpdateResult> updateOne(Object filter, Object update, UpdateOptions updateOptions);
     ...
     * @mongodb.driver.manual reference/operator/update/ Update Operators
     */
    MongoFuture<UpdateResult> updateMany(Object filter, Object update, UpdateOptions updateOptions);
