...
class AggregateFluentImpl<T> implements AggregateFluent<T> {
    ...
    AggregateFluentImpl(final MongoNamespace namespace, final Class<T> clazz, final CodecRegistry codecRegistry,
    ...
    @Override
    public AggregateFluent<T> allowDiskUse(final Boolean allowDiskUse) {
        this.allowDiskUse = allowDiskUse;
        return this;
    }

    @Override
    public AggregateFluent<T> batchSize(final int batchSize) {
        this.batchSize = batchSize;
        return this;
    }

    @Override
    public AggregateFluent<T> maxTime(final long maxTime, final TimeUnit timeUnit) {
    ...
    @Override
    public AggregateFluent<T> useCursor(final Boolean useCursor) {
    ...
    private MongoIterable<T> execute() {
        ...
        if (outCollection != null) {
            ...
            MongoIterable<T> delegated = new FindFluentImpl<T>(new MongoNamespace(namespace.getDatabaseName(),
