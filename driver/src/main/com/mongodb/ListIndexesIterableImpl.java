...
final class ListIndexesIterableImpl<TResult> implements ListIndexesIterable<TResult> {
    ...
    @Override
    public <NewTResult> ListIndexesIterable<NewTResult> toResultType(final Class<NewTResult> newResultClass) {
        return new ListIndexesIterableImpl<NewTResult>(namespace, newResultClass, codecRegistry, readPreference, executor);
    }
