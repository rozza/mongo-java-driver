...
/**
 * Fluent interface for map reduce.
 *
 * @param <T> The type of the result.
 * @since 3.0
 */
public interface MapReduceFluent<T> extends MongoIterable<T> {
     ...
     * @return this
     */
    MapReduceFluent<T> collectionName(final String collectionName);
     ...
     */
    MapReduceFluent<T> finalizeFunction(final String finalizeFunction);
     ...
     */
    MapReduceFluent<T> scope(final Object scope);
     ...
     */
    MapReduceFluent<T> sort(final Object sort);
     ...
     */
    MapReduceFluent<T> filter(final Object filter);
     ...
     */
    MapReduceFluent<T> limit(final int limit);
     ...
     * @mongodb.driver.manual reference/command/mapReduce mapReduce
     */
    MapReduceFluent<T> jsMode(final boolean jsMode);
     ...
     * @return this
     */
    MapReduceFluent<T> verbose(final boolean verbose);
     ...
     */
    MapReduceFluent<T> maxTime(final long maxTime, final TimeUnit timeUnit);
     ...
     * @return this
     */
    MapReduceFluent<T> action(final MapReduceAction action);
     ...
     */
    MapReduceFluent<T> databaseName(final String databaseName);
    /**
     ...
     * @mongodb.driver.manual reference/command/mapReduce/#output-to-a-collection-with-an-action output with an action
     */
    MapReduceFluent<T> sharded(final boolean sharded);
     ...
     * @mongodb.driver.manual reference/command/mapReduce/#output-to-a-collection-with-an-action output with an action
     */
    MapReduceFluent<T> nonAtomic(final boolean nonAtomic);
     ...
     */
    MapReduceFluent<T> batchSize(int batchSize);
}
