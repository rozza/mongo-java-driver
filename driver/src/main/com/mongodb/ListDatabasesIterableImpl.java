...
final class ListDatabasesIterableImpl<TResult> implements ListDatabasesIterable<TResult> {
    ...
    @Override
    public <NewTResult> ListDatabasesIterable<NewTResult> toResultType(final Class<NewTResult> newResultClass) {
        return new ListDatabasesIterableImpl<NewTResult>(newResultClass, codecRegistry, readPreference, executor);
    }
