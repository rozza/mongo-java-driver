 ...
 *
 * <p>
 * Encodes and decodes {@code Year} objects to and from {@code Int32}.
 * </p>
...
public class YearCodec implements Codec<Year> {
    ...
    @Override
    public Year decode(final BsonReader reader, final DecoderContext decoderContext) {
        validateIsNumeric(reader, BsonType.INT32, Year.class);
        return Year.of(decodeInt(reader));
    }

    @Override
    public void encode(final BsonWriter writer, final Year value, final EncoderContext encoderContext) {
