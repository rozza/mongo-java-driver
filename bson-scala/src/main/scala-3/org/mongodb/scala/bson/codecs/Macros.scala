...
object Macros {
   ...
   */
  @compileTimeOnly("Creating a Codec utilises Macros and must be run at compile time.")
  def createCodec[T](codecRegistry: CodecRegistry): Codec[T] = ???
   ...
   */
  @compileTimeOnly("Creating a Codec utilises Macros and must be run at compile time.")
  def createCodecIgnoreNone[T](): Codec[T] = ???
   ...
   */
  @compileTimeOnly("Creating a Codec utilises Macros and must be run at compile time.")
  def createCodecIgnoreNone[T](codecRegistry: CodecRegistry): Codec[T] = ???
