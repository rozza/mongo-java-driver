...
extra.setAll(
    mapOf(
        "mavenName" to "MongoDB Kotlin Driver Extensions",
        "mavenDescription" to "The MongoDB Kotlin Driver Extensions",
        "automaticModuleName" to "org.mongodb.driver.kotlin.extensions",
