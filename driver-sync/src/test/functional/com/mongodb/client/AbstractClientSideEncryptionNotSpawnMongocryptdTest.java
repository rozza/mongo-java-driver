...
public abstract class AbstractClientSideEncryptionNotSpawnMongocryptdTest {
    ...
    private static BsonDocument externalSchema() {
            return getTestDocument("specifications/source/client-side-encryption/external/external-schema.json");
    }

    private static BsonDocument externalKey() {
        return getTestDocument("specifications/source/client-side-encryption/external/external-key.json");
    }
