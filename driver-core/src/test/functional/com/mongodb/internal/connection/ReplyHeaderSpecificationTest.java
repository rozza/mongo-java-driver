...
class ReplyHeaderSpecificationTest {

    @ParameterizedTest
    @ValueSource(ints = {0, 1, 2, 3})
    void shouldParseReplyHeader(final int responseFlags) {
    ...
    @ParameterizedTest
    @ValueSource(ints = {0, 1, 2, 3})
    void shouldParseReplyHeaderWithCompressedHeader(final int responseFlags) {
        BasicOutputBuffer outputBuffer = new BasicOutputBuffer();
        outputBuffer.writeInt(186);
        outputBuffer.writeInt(45);
        outputBuffer.writeInt(23);
        ...
        ByteBuf byteBuf = outputBuffer.getByteBuffers().get(0);
        CompressedHeader compressedHeader = new CompressedHeader(byteBuf, new MessageHeader(byteBuf, getDefaultMaxMessageSize()));
    ...
    @Test
    void shouldThrowMongoInternalExceptionOnIncorrectOpCode() {
        BasicOutputBuffer outputBuffer = new BasicOutputBuffer();
    ...
    @Test
    void shouldThrowMongoInternalExceptionOnMessageSizeLessThan36() {
        BasicOutputBuffer outputBuffer = new BasicOutputBuffer();
    ...
    @Test
    void shouldThrowMongoInternalExceptionOnMessageSizeGreaterThanMaxMessageSize() {
        BasicOutputBuffer outputBuffer = new BasicOutputBuffer();
    ...
    @Test
    void shouldThrowMongoInternalExceptionOnNumDocumentsLessThanZero() {
        BasicOutputBuffer outputBuffer = new BasicOutputBuffer();
        outputBuffer.writeInt(186);
        outputBuffer.writeInt(45);
        outputBuffer.writeInt(23);
    ...
    @Test
    void shouldThrowMongoInternalExceptionOnNumDocumentsLessThanZeroWithCompressedHeader() {
        BasicOutputBuffer outputBuffer = new BasicOutputBuffer();
        outputBuffer.writeInt(186);
        outputBuffer.writeInt(45);
        outputBuffer.writeInt(23);
