...
public final class UnwindOptions {
     ...
     * @return this
     */
    public UnwindOptions setPreserveNullAndEmptyArrays(final boolean preserveNullAndEmptyArrays) {
     ...
     * @return this
     */
    public UnwindOptions setIncludeArrayIndex(final String includeArrayIndex) {
        this.includeArrayIndex = notNull("includeArrayIndex", includeArrayIndex);
        return this;
    }
}
