 ...
 *       read-only via {@link ByteBuf#asReadOnly()}, which creates shallow copies that share the same
 *       underlying data and reference count. The original buffers remain owned by the caller.</li>
