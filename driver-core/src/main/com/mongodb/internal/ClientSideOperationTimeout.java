 ...
 *
 * <p>Includes support for the deprecated {@code maxTimeMS}, {@code maxAwaitTimeMS} and {@code maxCommitTimeMS} operation configurations</p>
 */
public class ClientSideOperationTimeout {
    ...
    public long getMaxAwaitTimeMS() {
        return timeoutOrAlternative(maxAwaitTimeMS);
    }
