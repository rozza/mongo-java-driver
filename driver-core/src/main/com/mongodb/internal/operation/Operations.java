...
public final class Operations<TDocument> {
    ...
    public Operations(final Class<TDocument> documentClass, final ReadPreference readPreference,
    ...
    public Operations(@Nullable final MongoNamespace namespace, final Class<TDocument> documentClass, final ReadPreference readPreference,
    ...
    public <TResult> FindOperation<TResult> find(final MongoNamespace findNamespace, @Nullable final Bson filter,
    ...
    public <TResult> DistinctOperation<TResult> distinct(final String fieldName, @Nullable final Bson filter, final Class<TResult> resultClass,
    ...
    public WriteOperation<BulkWriteResult> insertOne(final TDocument document, final InsertOneOptions options) {
        return bulkWrite("insert", singletonList(new InsertOneModel<>(document)),
    ...
    public WriteOperation<BulkWriteResult> replaceOne(final Bson filter, final TDocument replacement, final ReplaceOptions options) {
        return bulkWrite("replaceOne", singletonList(new ReplaceOneModel<>(filter, replacement, options)),
    ...
    public WriteOperation<BulkWriteResult> deleteOne(final Bson filter, final DeleteOptions options) {
        return bulkWrite("deleteOne", singletonList(new DeleteOneModel<>(filter, options)),
    ...
    public WriteOperation<BulkWriteResult> deleteMany(final Bson filter, final DeleteOptions options) {
        return bulkWrite("deleteMany", singletonList(new DeleteManyModel<>(filter, options)),
                new BulkWriteOptions().comment(options.getComment()).let(options.getLet()));
    }

    public WriteOperation<BulkWriteResult> updateOne(final Bson filter, final Bson update, final UpdateOptions options) {
        return bulkWrite("updateOne", singletonList(new UpdateOneModel<>(filter, update, options)),
                new BulkWriteOptions().bypassDocumentValidation(options.getBypassDocumentValidation())
                        .comment(options.getComment()).let(options.getLet()));
    }
    ...
    public WriteOperation<BulkWriteResult> updateMany(final Bson filter, final Bson update, final UpdateOptions options) {
        return bulkWrite("updateMany", singletonList(new UpdateManyModel<>(filter, update, options)),
                new BulkWriteOptions().bypassDocumentValidation(options.getBypassDocumentValidation())
                        .comment(options.getComment()).let(options.getLet()));
    }
    ...
    public WriteOperation<BulkWriteResult> bulkWrite(final String operationName,
    ...
    public UpdateSearchIndexesOperation updateSearchIndex(final String indexName, final Bson definition) {
    ...
    public <TResult> ListIndexesOperation<TResult> listIndexes(final Class<TResult> resultClass, @Nullable final Integer batchSize,
            final BsonValue comment, @Nullable final TimeoutMode timeoutMode) {
    ...
    public <TResult> ChangeStreamOperation<TResult> changeStream(final FullDocument fullDocument,
