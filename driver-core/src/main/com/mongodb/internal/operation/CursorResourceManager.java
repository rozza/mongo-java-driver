...
import static com.mongodb.internal.Locks.withLockNullable;
...
abstract class CursorResourceManager<CS extends ReferenceCounted, C extends ReferenceCounted> {
    ...
    abstract <R> void executeWithConnection(AsyncCallableWithCallback<R> callable, SingleResultCallback<R> callback);
    ...
    void releaseServerAndClientResources(final C connection) {
        ServerCursor localServerCursor = withLockNullable(lock, () -> {
