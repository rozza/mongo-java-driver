...
tasks.withType<Javadoc> {
    ...
    afterEvaluate {
        ...
        if (project.name != "mongodb-driver-core") linksOfflineHelper(docVersion, "mongodb-driver-core", standardDocletOptions)
        if (project.name != "mongodb-driver-sync") linksOfflineHelper(docVersion, "mongodb-driver-sync", standardDocletOptions)
    }
}

fun docVersion(version: String): String {
...
fun linksOfflineHelper(docVersion: String, packageName: String, options: StandardJavadocDocletOptions): Unit {
