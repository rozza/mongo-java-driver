...
final class MongoCollectionImpl<T> implements MongoCollection<T> {
    ...
    public Publisher<Long> estimatedDocumentCount(final EstimatedDocumentCountOptions options) {
        return PublisherCreator.createReadOperationPublisher(() ->
                        operations.count(new BsonDocument(), fromEstimatedDocumentCountOptions(options), CountStrategy.COMMAND),
                null, readPreference, readConcern, executor);
    }
    ...
    public Publisher<Long> countDocuments(final Bson filter, final CountOptions options) {
        return PublisherCreator.createReadOperationPublisher(() ->
                        operations.count(new BsonDocument(), options, CountStrategy.AGGREGATE),
                null, readPreference, readConcern, executor);
    }
    ...
    public Publisher<Long> countDocuments(final ClientSession clientSession, final Bson filter, final CountOptions options) {
        return PublisherCreator.createReadOperationPublisher(() -> operations.count(new BsonDocument(), options, CountStrategy.AGGREGATE),
                notNull("clientSession", clientSession), readPreference, readConcern, executor);
    }
    ...
    public <TResult> DistinctPublisher<TResult> distinct(final String fieldName, final Bson filter, final Class<TResult> resultClass) {
        return PublisherCreator.createDistinctPublisher(null, getNamespace(),
                getDocumentClass(), resultClass, getCodecRegistry(),
                getReadPreference(), getReadConcern(), getExecutor(), fieldName, filter, getRetryReads());
    }
    ...
    public <TResult> AggregatePublisher<TResult> aggregate(final List<? extends Bson> pipeline, final Class<TResult> clazz) {
        return PublisherCreator.createAggregatePublisher(null, getNamespace(), getDocumentClass(), clazz, getCodecRegistry(),
                getReadPreference(), getReadConcern(), getWriteConcern(), getExecutor(), pipeline, AggregationLevel.COLLECTION,
                getRetryReads());
    }
    ...
    public <TResult> AggregatePublisher<TResult> aggregate(final ClientSession clientSession, final List<? extends Bson> pipeline,
        ...
        return PublisherCreator.createAggregatePublisher(notNull("clientSession", clientSession), getNamespace(), getDocumentClass(),
                clazz, getCodecRegistry(), getReadPreference(), getReadConcern(), getWriteConcern(), getExecutor(), pipeline,
    ...
    public <TResult> ChangeStreamPublisher<TResult> watch(final List<? extends Bson> pipeline, final Class<TResult> resultClass) {
        return PublisherCreator.createChangeStreamPublisher(null, getNamespace(), resultClass,
                getCodecRegistry(), getReadPreference(), getReadConcern(), getExecutor(), pipeline, ChangeStreamLevel.COLLECTION,
                getRetryReads());
    }
    ...
    public <TResult> MapReducePublisher<TResult> mapReduce(final String mapFunction, final String reduceFunction,
        ...
        return PublisherCreator.createMapReducePublisher(null, getNamespace(), getDocumentClass(), clazz, getCodecRegistry(),
                getReadPreference(), getReadConcern(), getWriteConcern(), getExecutor(), mapFunction, reduceFunction);
    }
    ...
    public <TResult> MapReducePublisher<TResult> mapReduce(final ClientSession clientSession, final String mapFunction,
        ...
        return PublisherCreator.createMapReducePublisher(notNull("clientSession", clientSession), getNamespace(), getDocumentClass(),
                clazz, getCodecRegistry(), getReadPreference(), getReadConcern(), getWriteConcern(), getExecutor(), mapFunction,
                reduceFunction);
    }
    ...
    public Publisher<BulkWriteResult> bulkWrite(final List<? extends WriteModel<? extends T>> requests,
        ...
        return PublisherCreator.createWriteOperationPublisher(() -> operations.bulkWrite(requests, options), null, readConcern, executor);
    }
    ...
    public Publisher<BulkWriteResult> bulkWrite(final ClientSession clientSession,
                                                final List<? extends WriteModel<? extends T>> requests,
                                                final BulkWriteOptions options) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.bulkWrite(requests, options),
                notNull("clientSession", clientSession), readConcern, executor);
    }
    ...
    public Publisher<InsertOneResult> insertOne(final T document, final InsertOneOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.insertOne(document, options), null, readConcern, executor, WriteRequest.Type.INSERT)
    ...
    public Publisher<InsertOneResult> insertOne(final ClientSession clientSession, final T document,
        ...
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.insertOne(document, options),
                notNull("clientSession", clientSession), readConcern, executor, WriteRequest.Type.INSERT)
                .map(INSERT_ONE_RESULT_MAPPER);
    }
    ...
    public Publisher<InsertManyResult> insertMany(final List<? extends T> documents, final InsertManyOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.insertMany(documents, options),
                null, readConcern, executor, WriteRequest.Type.INSERT)
    ...
    public Publisher<DeleteResult> deleteOne(final Bson filter, final DeleteOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.deleteOne(filter, options),
                null, readConcern, executor, WriteRequest.Type.DELETE)
    ...
    public Publisher<DeleteResult> deleteOne(final ClientSession clientSession, final Bson filter, final DeleteOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.deleteOne(filter, options),
                notNull("clientSession", clientSession), readConcern, executor, WriteRequest.Type.DELETE)
                .map(DELETE_RESULT_MAPPER);
    }
    ...
    public Publisher<DeleteResult> deleteMany(final Bson filter, final DeleteOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.deleteMany(filter, options),
                null, readConcern, executor, WriteRequest.Type.DELETE)
                .map(DELETE_RESULT_MAPPER);
    }
    ...
    public Publisher<UpdateResult> replaceOne(final Bson filter, final T replacement, final ReplaceOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.replaceOne(filter, replacement, options),
                null, readConcern, executor, WriteRequest.Type.REPLACE)
    ...
    public Publisher<UpdateResult> replaceOne(final ClientSession clientSession, final Bson filter, final T replacement,
        ...
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.replaceOne(filter, replacement, options),
                notNull("clientSession", clientSession), readConcern, executor, WriteRequest.Type.REPLACE)
                .map(UPDATE_RESULT_MAPPER);
    }
    ...
    public Publisher<UpdateResult> updateOne(final Bson filter, final Bson update, final UpdateOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.updateOne(filter, update, options),
                null, readConcern, executor, WriteRequest.Type.UPDATE)
                .map(UPDATE_RESULT_MAPPER);
    }
    ...
    public Publisher<UpdateResult> updateOne(final ClientSession clientSession, final Bson filter, final Bson update,
        ...
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.updateOne(filter, update, options),
                notNull("clientSession", clientSession), readConcern, executor, WriteRequest.Type.UPDATE)
                .map(UPDATE_RESULT_MAPPER);
    }
    ...
    public Publisher<UpdateResult> updateMany(final Bson filter, final Bson update, final UpdateOptions options) {
        return PublisherCreator.createSingleWriteRequestPublisher(() -> operations.updateMany(filter, update, options),
                null, readConcern, executor, WriteRequest.Type.UPDATE)
                .map(UPDATE_RESULT_MAPPER);
    }
    ...
    public Publisher<T> findOneAndDelete(final Bson filter, final FindOneAndDeleteOptions options) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.findOneAndDelete(filter, options), null, readConcern, executor);
    }
    ...
    public Publisher<T> findOneAndDelete(final ClientSession clientSession, final Bson filter,
        ...
        return PublisherCreator.createWriteOperationPublisher(() -> operations.findOneAndDelete(filter, options),
                notNull("clientSession", clientSession), readConcern, executor);
    }
    ...
    public Publisher<T> findOneAndReplace(final Bson filter, final T replacement, final FindOneAndReplaceOptions options) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.findOneAndReplace(filter, replacement, options),
                null, readConcern, executor);
    }
    ...
    public Publisher<T> findOneAndUpdate(final Bson filter, final Bson update, final FindOneAndUpdateOptions options) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.findOneAndUpdate(filter, update, options),
                null, readConcern, executor);
    }
    ...
    public Publisher<Void> drop() {
        return PublisherCreator.createWriteOperationPublisher(operations::dropCollection, null, readConcern, executor);
    }

    @Override
    public Publisher<Void> drop(final ClientSession clientSession) {
        return PublisherCreator.createWriteOperationPublisher(operations::dropCollection,
                notNull("clientSession", clientSession), readConcern, executor);
    }
    ...
    public Publisher<String> createIndex(final Bson key, final IndexOptions options) {
        return Mono.from(createIndexes(singletonList(new IndexModel(key, options))));
    }
    ...
    public Publisher<String> createIndex(final ClientSession clientSession, final Bson key, final IndexOptions options) {
        return Mono.from(createIndexes(clientSession, singletonList(new IndexModel(key, options))));
    }
    ...
    public Publisher<String> createIndexes(final List<IndexModel> indexes, final CreateIndexOptions createIndexOptions) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.createIndexes(indexes, createIndexOptions),
                null, readConcern, executor)
                .map(v -> IndexHelper.getIndexNames(indexes, codecRegistry))
                .flux()
    ...
    public Publisher<Void> dropIndex(final String indexName, final DropIndexOptions dropIndexOptions) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.dropIndex(indexName, dropIndexOptions),
                null, readConcern, executor);
    }

    @Override
    public Publisher<Void> dropIndex(final Bson keys, final DropIndexOptions dropIndexOptions) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.dropIndex(keys, dropIndexOptions),
                null, readConcern, executor);
    }
    ...
    public Publisher<Void> renameCollection(final MongoNamespace newCollectionNamespace, final RenameCollectionOptions options) {
        return PublisherCreator.createWriteOperationPublisher(() -> operations.renameCollection(newCollectionNamespace, options),
                null, readConcern, executor);
    }
    ...
    private final static Function<BulkWriteResult, InsertOneResult> INSERT_ONE_RESULT_MAPPER = result -> {
    ...
    private final static Function<BulkWriteResult, InsertManyResult> INSERT_MANY_RESULT_MAPPER = result -> {
        if (result.wasAcknowledged()) {
    ...
    private final static Function<BulkWriteResult, DeleteResult> DELETE_RESULT_MAPPER = result -> {
        if (result.wasAcknowledged()) {
    ...
    private final static Function<BulkWriteResult, UpdateResult> UPDATE_RESULT_MAPPER = result -> {
        if (result.wasAcknowledged()) {
