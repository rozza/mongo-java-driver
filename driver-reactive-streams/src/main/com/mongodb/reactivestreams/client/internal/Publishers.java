...
public final class Publishers {
    ...
    /**
     * Convert a {@link MongoIterable} into an {@link Publisher}.
     *
     ...
     */
    public static <TResult> Publisher<TResult> publish(final MongoIterable<TResult> mongoIterable) {
     ...
     * For example, converting {@link MongoCollection#countDocuments(SingleResultCallback)} into an {@link Publisher}:
     * <pre>
     * {@code
