...
import static com.mongodb.reactivestreams.client.internal.reactor.gridfs.GridFSPublisherCreator.createDeletePublisher;
import static com.mongodb.reactivestreams.client.internal.reactor.gridfs.GridFSPublisherCreator.createDropPublisher;
import static com.mongodb.reactivestreams.client.internal.reactor.gridfs.GridFSPublisherCreator.createGridFSDownloadPublisher;
import static com.mongodb.reactivestreams.client.internal.reactor.gridfs.GridFSPublisherCreator.createGridFSFindPublisher;
import static com.mongodb.reactivestreams.client.internal.reactor.gridfs.GridFSPublisherCreator.createGridFSUploadPublisher;
import static com.mongodb.reactivestreams.client.internal.reactor.gridfs.GridFSPublisherCreator.createRenamePublisher;
...
public final class GridFSBucketImpl implements GridFSBucket {
    ...
    public GridFSUploadPublisher<Void> uploadFromPublisher(final BsonValue id, final String filename, final Publisher<ByteBuffer> source,
                                                           final GridFSUploadOptions options) {
        return createGridFSUploadPublisher(chunkSizeBytes, filesCollection, chunksCollection, null, new BsonObjectId(),
    ...
    public GridFSUploadPublisher<ObjectId> uploadFromPublisher(final ClientSession clientSession, final String filename,
        ...
        return createGridFSUploadPublisher(chunkSizeBytes, filesCollection, chunksCollection,
                notNull("clientSession", clientSession), new BsonObjectId(), filename, options, source).withObjectId();
    }
