...
final class FindPublisherImpl<D, T> extends MongoBatchCursorPublisher<T> implements FindPublisher<T> {
    ...
    public FindPublisherImpl(@Nullable final ClientSession clientSession, final MongoNamespace namespace,
