...
public class BatchCursorPublisherImplTest {
    ...
    BatchCursorPublisherImpl<Document> createVerifiableBatchCursor(final List<Document> expected) {
    ...
    BatchCursorPublisherImpl<Document> createVerifiableBatchCursorError() {
        return createVerifiableBatchCursor(emptyList(), 0, true, false);
    }

    BatchCursorPublisherImpl<Document> createVerifiableBatchCursorError(final List<Document> expected) {
            ...
            Mockito.doAnswer(invocation -> {
                ...
                return null;
                    ...
                    .execute(eq(readOperation),
                             ...
                             eq(null),
                             any(SingleResultCallback.class));
        } else {
            Mockito.doAnswer(invocation -> {
