...
import static com.mongodb.reactivestreams.client.internal.reactor.PublisherCreator.createListIndexesPublisher;
...
public class ListIndexesPublisherImplTest extends TestHelper {
    ...
    void shouldBuildTheExpectedOperation() {
        ...
        ListIndexesPublisher<Document> publisher = createListIndexesPublisher(null, NAMESPACE, Document.class,
                getDefaultCodecRegistry(), ReadPreference.primary(), executor, true);

        ListIndexesOperation<Document> expectedOperation = new ListIndexesOperation<>(NAMESPACE, getDefaultCodecRegistry().get(Document.class))
                .retryReads(true);
