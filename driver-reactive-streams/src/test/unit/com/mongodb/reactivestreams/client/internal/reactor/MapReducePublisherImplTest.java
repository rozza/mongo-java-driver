...
import static com.mongodb.reactivestreams.client.internal.reactor.PublisherCreator.createMapReducePublisher;
...
public class MapReducePublisherImplTest extends TestHelper {
    ...
    private final static String MAP_FUNCTION = "mapFunction(){}";
    private final static String REDUCE_FUNCTION = "reduceFunction(){}";
    private final static String FINALIZE_FUNCTION = "finalizeFunction(){}";
    ...
    void shouldBuildTheExpectedMapReduceWithInlineResultsOperation() {
        ...
        MapReduceWithInlineResultsOperation<Document> expectedOperation = new MapReduceWithInlineResultsOperation<>(NAMESPACE,
    ...
    void shouldBuildTheExpectedMapReduceToCollectionOperation() {
        ...
        MapReducePublisher<Document> publisher = createMapReducePublisher(null, NAMESPACE, Document.class, Document.class,
                getDefaultCodecRegistry(), ReadPreference.primary(), ReadConcern.DEFAULT, WriteConcern.ACKNOWLEDGED,
                executor, MAP_FUNCTION, REDUCE_FUNCTION).collectionName(NAMESPACE.getCollectionName());
