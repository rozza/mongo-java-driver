...
import static com.mongodb.reactivestreams.client.internal.reactor.PublisherCreator.createFindPublisher;
...
public class FindPublisherImplTest extends TestHelper {
    ...
    void shouldBuildTheExpectedOperation() {
        ...
        FindPublisher<Document> publisher = createFindPublisher(null, NAMESPACE, Document.class, Document.class,
                getDefaultCodecRegistry(), ReadPreference.primary(), ReadConcern.DEFAULT, executor, new Document(), true);
