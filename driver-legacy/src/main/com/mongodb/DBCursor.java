...
public class DBCursor implements Cursor, Iterable<DBObject> {
    ...
    private ClientSideOperationTimeoutFactory createClientSideOperationFactory() {
        ...
        return ClientSideOperationTimeoutFactories.create(collection.getTimeout(MILLISECONDS),
                                                          findOptions.getMaxTime(MILLISECONDS), findOptions.getMaxAwaitTime(MILLISECONDS));
    }
