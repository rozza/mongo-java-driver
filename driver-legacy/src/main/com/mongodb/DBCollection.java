...
import static com.mongodb.TimeoutContextHelper.getTimeoutContext;
...
public class DBCollection {
    ...
    public long getCount(@Nullable final DBObject query, final DBCollectionCountOptions options) {
        ...
        return executor.withTimeoutContext(getTimeoutContext(getTimeoutSettings(), options))
    ...
    public MapReduceOutput mapReduce(final MapReduceCommand command) {
        ...
        if (command.getOutputType() == MapReduceCommand.OutputType.INLINE) {
            ...
            MapReduceBatchCursor<DBObject> executionResult = executor
                    .withTimeoutContext(getTimeoutContext(getTimeoutSettings(), command))
        ...
        if (outCollection != null) {
            AggregateToCollectionOperation operation =
                    new AggregateToCollectionOperation(
                            ...
                            .collation(options.getCollation());
            try {
                executor.withTimeoutContext(getTimeoutContext(getTimeoutSettings(), options))
    ...
    public DBObject findAndModify(final DBObject query, final DBCollectionFindAndModifyOptions options) {
        ...
        try {
            return executor.withTimeoutContext(getTimeoutContext(getTimeoutSettings(), options)).execute(operation, getReadConcern());
        } catch (MongoWriteConcernException e) {
            throw createWriteConcernException(e);
        }
    }
