...
- The following Pojo classes. For the full source is available on github for the [Person]({{< srcref "driver/src/examples/tour/Person.java">}}) and [Address]({{< srcref "driver/src/examples/tour/Address.java">}})
...
For additional information about the configuring the `PojoCodecProvider`, see the [Bson Pojos page]({{< ref "bson/pojos.md" >}}).
