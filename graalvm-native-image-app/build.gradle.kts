...
val applicationName: String = "NativeImageApp"
application {
    mainClass = "com.mongodb.internal.graalvm.$applicationName"
}
...
tasks.withType<Jar> {
    manifest {
        attributes["Main-Class"] = "com.mongodb.internal.graalvm.$applicationName"
    }
}
...
val javaLanguageVersion = JavaLanguageVersion.of(graalJavaVersion)
