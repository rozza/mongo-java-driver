...
case class GridFSBucket(private val wrapped: JGridFSBucket) {
  ...
  def uploadFromObservable(filename: String, source: Observable[ByteBuffer]): GridFSUploadObservable[BsonObjectId] =
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(filename, source)).withObjectId()
  ...
  ): GridFSUploadObservable[BsonObjectId] =
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(filename, source, options)).withObjectId()
  ...
  def uploadFromObservable(
    ...
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(id, filename, source))
  ...
  def uploadFromObservable(
    ...
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(id, filename, source, options))
  ...
  def uploadFromObservable(
    ...
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(clientSession, filename, source)).withObjectId()
  ...
  def uploadFromObservable(
    ...
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(clientSession, filename, source, options)).withObjectId()
  ...
  def uploadFromObservable(
    ...
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(clientSession, id, filename, source))
  ...
  def uploadFromObservable(
    ...
    GridFSUploadObservableImpl(wrapped.uploadFromPublisher(clientSession, id, filename, source, options))
